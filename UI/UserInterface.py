...
class UserInterface(TkinterDnD.Tk):
    ...
    def sideBar(self):
        ...
        uni_Logo = ImageTk.PhotoImage(img.resize((90, 30)))

        # Make the buttons with the icons to be shown
        uni_label = tk.Label(sid_bar_frame, image=uni_Logo, highlightbackground='white', activebackground='white',
                             relief='flat')
...
class MainPage(tk.Frame):
    ...
    def repage(self):
        ...
        sideFrame = tk.Frame(container, bg='#191970', width=110,
        ...
        self.resultListBox.grid(column=1, row=1, padx=20, pady=10, columnspan=2)
        ...
        result = Button(resultButtonFrame, text="Download all report", fg="black", width=150,
